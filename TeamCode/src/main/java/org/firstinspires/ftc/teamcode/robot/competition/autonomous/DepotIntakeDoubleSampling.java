...
@Autonomous(name = "Depot - Competition Intake - Double Sampling")
@Disabled
public class DepotIntakeDoubleSampling extends LinearOpMode  {
   ...
   MMMADS myMineralMinerAll;
    MMMCDS myMineralMinerCrater;
    MMMDDS myMineralMinerDepot;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        myMineralMinerCrater = new MMMCDS();
        myMineralMinerCrater.setLinearOp(this);

        myMineralMinerDepot = new MMMDDS();
        ...
        myMineralMinerDepot.knockingOffSecondMineral(myGyro, myMechDrive);
        sleep(sleepTime);
        idle();
